...
function HeartIcon({likeAPost, postId}) {
  return (
    <WorkoutIcons>
  <svg onClick={()=> likeAPost(postId)} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
...
function UnHeartIcon({unlikeAPost, postId}) {
  return (
    <WorkoutIcons>
  <svg onClick={()=> unlikeAPost(postId)} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="black" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
  <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
  </WorkoutIcons>
  )
}
...
function SaveIcon({saveAWorkout, workoutId}) {
  return (
    <WorkoutIcons>
        <svg onClick={() => saveAWorkout(workoutId)}
        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bookmark">
          <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>
    </WorkoutIcons>
  )
...
function DeleteSaveIcon({deleteSavedWorkout, workoutId}) {
  return (
    <WorkoutIcons>
        <svg onClick={() => deleteSavedWorkout(workoutId)}
        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="black" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bookmark">
          <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>
    </WorkoutIcons>
  )
}
...
function DeletePostIcon({deletePost, postId}) {
  return (
    ...
    stroke-linecap="round" 
    stroke-linejoin="round" 
    class="feather feather-trash-2 deletePost">
